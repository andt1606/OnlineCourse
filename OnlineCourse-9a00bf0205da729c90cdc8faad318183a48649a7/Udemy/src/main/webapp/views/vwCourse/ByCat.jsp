...
<%--                    <div class="course__container-top-content-title">Practical MongoDB + PHP: For Absolute Beginners</div>--%>
<%--                    <p class="course__container-top-content-tinydes">Master yourself in NoSQL Database MongoDB with Hands-on Practical Examples. PHP & MongoDB practical projects.</p>--%>

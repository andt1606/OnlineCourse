...
<t:main>
    ...
    <jsp:body>
        ...
        <jsp:include page="../partials/backgroundd.jsp"></jsp:include>
                ...
                <div class="info__content">
                    <div class="info__item">
                        ...
                        <div class="info__item__detail">
                            ...
                            <p style="font-size: 13px">Enjoy a variety of fresh topics</p>
                        </div>
                    </div>
                    <div class="info__item">
                        ...
                        <div class="info__item__detail">
                            ...
                            <p style="font-size: 13px">Find the right instructor for you</p>
                        </div>
                    </div>
                    <div class="info__item">
                        ...
                        <div class="info__item__detail">
                            ...
                            <p style="font-size: 13px">Learn on your schedule</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="mid__content">
                    <div class="mid__item">
                        ...
                        <div class="mid__item__detail mid__item__icon">
                            ...
                            <p style="font-size: 13px">Enjoy lifetime access to courses on</p>
                            <p style="font-size: 13px">Udemy’s website and app</p>
                    ...
                    <div class="mid__item">
                        ...
                        <div class="mid__item__detail">
                            ...
                            <p style="font-size: 13px">Select from top instructors around the</p>
                            <p style="font-size: 13px">world</p>
                        </div>
                    </div>
                    <div class="mid__item">
                        ...
                        <div class="mid__item__detail">
                            ...
                            <p style="font-size: 13px">Build your library for your career and</p>
                            <p style="font-size: 13px">personal growth</p>
                        </div>
                    </div>
                </div>
            </div>
